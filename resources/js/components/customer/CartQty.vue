<template>
    <li class="relative flex items-center cursor-pointer my-3 md:mb-0 hover:text-custom-gray-lighter">
        <a :href="`/cart-details`">
            <svg fill="currentColor" class="h-8 w-8 text-custom-light-black" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <span class="absolute top-0 right-0 -mt-2 -mr-2 text-custom-red-lighter p-1  rounded-full">{{ cartTotalQty }}</span>
        </a>
    </li>
</template>
<script>
