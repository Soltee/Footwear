    ...
    <ul class="m-0 flex flex-col justify-start items-left ">
        <li class="mb-3">
            <a href="/admin/dashboard" 
                :class="(route === 'administrator-dashboard') ? 'bg-admin-btn  text-white' : ''"
                class=" text-md font-bold flex flex-row hover:bg-admin-btn hover:text-white rounded-lg px-3 py-2  items-center">
                <svg class="h-8 w-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <li class="mb-3">
            <a href="/admin/categories" 
                :class="(route === 'categories') ? 'bg-admin-btn  text-white' : ''"
                class=" text-md font-bold flex flex-row items-center hover:bg-admin-btn hover:text-white rounded-lg px-3 py-2 ">
                <svg class="h-8 w-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <li class="mb-3">
            <a href="/admin/products" 
                :class="(route === 'products') ? 'bg-admin-btn  text-white' : ''"
                class=" text-md font-bold flex flex-row items-center hover:bg-admin-btn hover:text-white rounded-lg px-3 py-2 ">
                <svg class="h-8 w-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd">
        ...
        <li class="mb-3">
            <a href="/admin/customers" 
                :class="(route === 'customers') ? 'bg-admin-btn  text-white' : ''"
                class=" text-md font-bold flex flex-row items-center hover:bg-admin-btn hover:text-white rounded-lg px-3 py-2  ">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <li class="mb-3">
            <a href="/admin/payments" 
                :class="(route === 'payments') ? 'bg-admin-btn  text-white' : ''"
                class=" text-md font-bold flex flex-row  hover:bg-admin-btn hover:text-white rounded-lg px-3 py-2 items-center"
                >
