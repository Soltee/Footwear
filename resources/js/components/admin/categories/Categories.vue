            ...
            <div class="w-full flex flex-col  sm:flex-row sm:justify-between items-center">
                <div class="w-full flex flex-row justify-between items-center sm:w-auto mb-2 sm:mb-0">
                    <div class="flex flex-row items-center">
                        ...
                        <svg v-if="!categoryStatus" @click="categoryStatus = true;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-gray-800 ml-2 cursor-pointer">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                        <svg v-if="categoryStatus" @click="categoryStatus = false;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-gray-800 ml-2 cursor-pointer">
                ...
                <div class="w-full flex flex-row justify-between items-center sm:w-auto">
                    <svg @click="selectedCategory =  null; category = ''; reset();" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 mr-2 cursor-pointer">
                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-white rounded-lg">
                                ...
                                <th class="whitespace-no-wrap  px-4 py-3 text-left text-gray-900">Created At</th>
                            ...
                            <tr v-if="searchStatus && (categorySearchArray.length > 0)" v-for="category in categorySearchArray" class="relative">
                                ...
                                <td class="whitespace-no-wrap ">
                                    <div class="flex justify-around items-center">
                                        <svg @click="type = 'category'; displayEditModal(category)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1 md:mb-0 h-6 w-6 md:h-8 md:h-8 cursor-pointer">
                                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg>
                                        <svg @click="selectedCategory = category; categoryStatus = false; getSubCategories();" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800 hover:text-green-600 cursor-pointer" fill="currentColor" :class="" viewBox="0 0 24 24">
                                            <path d="M0 11c.511-6.158 5.685-11 12-11s11.489 4.842 12 11h-2.009c-.506-5.046-4.793-9-9.991-9s-9.485 3.954-9.991 9h-2.009zm21.991 2c-.506 5.046-4.793 9-9.991 9s-9.485-3.954-9.991-9h-2.009c.511 6.158 5.685 11 12 11s11.489-4.842 12-11h-2.009z" /></svg>
                                        <svg @click="type = 'category';  displayDeleteModal(category)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1 md:mb-0 h-6 w-6 md:h-8 md:h-8 text-admin-red">
            ...
            <div class="w-full flex flex-col  sm:flex-row sm:justify-between items-center">
                <div class="w-full flex flex-row justify-between items-center sm:w-auto mb-2 sm:mb-0">
                    <div class="flex flex-row items-center">
                        ...
                        <svg v-if="!subcategoryStatus" @click="subcategoryStatus = true;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-gray-800 ml-2 cursor-pointer">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                        <svg v-if="subcategoryStatus" @click="subcategoryStatus = false;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-gray-800 ml-2 cursor-pointer">
                            <polyline points="18 15 12 9 6 15"></polyline>
                        </svg>
                    </div>
                ...
                <div class="w-full flex flex-row justify-between items-center sm:w-auto">
                    <svg @click="subcategory = '';" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 mr-2 cursor-pointer">
                        <polyline points="23 4 23 10 17 10"></polyline>
                        <path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"></path>
                    </svg>
                    <div class="relative flex items-center">
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            <tr v-if="subSearchStatus && (subcategorySearchArray.length > 0)" v-for="subcategory in subcategorySearchArray">
                                ...
                                <td class="whitespace-no-wrap ">
                                    <div class="flex justify-around items-center">
                                        <svg @click="type = 'subcategory'; displayEditModal(subcategory)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1 md:mb-0 h-6 w-6 md:h-8 md:h-8 cursor-pointer">
                                            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                            <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                        </svg>
                                        <svg @click="type = 'subcategory'; displayDeleteModal(subcategory)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mb-1 md:mb-0 h-6 w-6 md:h-8 md:h-8 text-admin-red">
                                            <path d="M21 4H8l-7 8 7 8h13a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path>
                                            <line x1="18" y1="9" x2="12" y2="15"></line>
                                            <line x1="12" y1="9" x2="18" y2="15"></line>
                                        </svg>
