                    ...
                    <div class="overflow-x-scroll w-full mt-6 md:overflow-hidden">
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tbody>
                                 ...
                                 <tr v-if="searchStatus" v-for="category in categorySearchArray" class="relative">
                                ...
                                <tr v-if="!searchStatus" v-for="category in categoryArray">
                                  <td class="border px-4 py-2 text-gray-900">{{ category.name }}</td>
                                  <td class="border px-4 py-2 text-gray-900">{{ category.created_at }}</td>
                                  <td class="">
                                    <div class="flex justify-around items-center">  
            ...
            <div class="mb-2">
                <div class="flex flex-row justify-between items-center">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <svg @click="subSearchStatus = false;" xmlns="http://www.w3.org/2000/svg" class="absolute right-0 top-0 mt-1 mr-2 h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-scroll w-full mt-6 md:overflow-hidden">
                        ...
                        <table class="w-full table-auto">
                            ...
                            <tbody>
                                 ...
                                 <tr v-if="subSearchStatus" v-for="subcategory in subcategorySearchArray">
                                ...
                                <tr v-if="!subSearchStatus" v-for="subcategory in subcategoryArray">
                                  <td class="border px-4 py-2 text-gray-900">{{ subcategory.name }}</td>
                                  <td class="border px-4 py-2 text-gray-900">{{ subcategory.created_at }}</td>
                                  <td class="">
                                    <div class="flex justify-around items-center">  
...
import CreateModal from '../helpers/CreateModal';
    ...
    export default {
        ...
        methods: {
            ...
            dropCategory(){
                axios.delete(`/admin/categories/${this.selected.id}`)
                    .then((res) => {
                        if(res.status == 204){
                            Toast.fire({
                              icon: 'success',
