        ...
        <div class="absolute  bg-gray-400 left-0 right-0  mx-auto  max-w-xl shadow-lg rounded-lg p-6 z-30">
            ...
            <div>
                <div v-if="type == 'category'" class="">
                    <h3 class="text-admin-btn text-lg font-bold my-2">Edit Category</h3>
                ...
                <div v-if="type == 'subcategory'" class="">
                    <h3 class="text-admin-btn text-lg font-bold my-2">Edit Subcategory</h3>
        ...
        methods: {
            ...
            edit(){
                ...
                if(this.type == 'category'){
                    endpoint += `/categories/${this.data.id}`;
                } else if(this.type == 'subcategory'){
                    endpoint += `/subcategories/${this.data.id}`;
                    formData.append('category', this.category);
                }
                // console.log(formDa?ta);
