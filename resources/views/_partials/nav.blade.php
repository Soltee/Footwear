<ul class="m-0 flex flex-col justify-start items-left ">
	<li class="mb-3">
		<a href="{{ route('administrator-dashboard') }}" class="text-gray-900 text-md font-bold flex flex-row bg-admin-btn-hover hover:bg-admin-btn rounded-lg px-3 py-2 {{ (Route::currentRouteName() == 'administrator-dashboard') ? 'bg-admin-btn' : '' }} items-center">
	...
	<li class="mb-3">
		<a href="{{ route('products') }}" class="text-gray-900 text-md font-bold flex flex-row items-center bg-admin-btn-hover hover:bg-admin-btn rounded-lg px-3 py-2 {{ (Route::currentRouteName() == 'products') ? 'bg-admin-btn' : '' }} ">
	...
	<li class="mb-3">
		<a href="{{ route('customers') }}" class="text-gray-900 text-md font-bold flex flex-row items-center bg-admin-btn-hover hover:bg-admin-btn rounded-lg px-3 py-2 {{ (Route::currentRouteName() == 'customers') ? 'bg-admin-btn' : '' }} ">
	...
	<li class="mb-3">
		<a href="{{ route('administrator-profile') }}" class="text-gray-900 text-md font-bold flex flex-row  bg-admin-btn-hover hover:bg-admin-btn rounded-lg px-3 py-2 {{ (Route::currentRouteName() == 'payments') ? 'bg-admin-btn' : '' }} items-center">
