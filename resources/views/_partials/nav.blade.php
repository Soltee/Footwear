<ul class="m-0 flex flex-col justify-start items-left ">
	...
	<li class="mb-3">
		<a href="{{ route('administrator-profile') }}" class="text-gray-900 text-md font-bold flex flex-row   hover:bg-admin-btn rounded-lg px-3 py-2 {{ (Route::currentRouteName() == 'payments') ? 'bg-admin-btn' : 'bg-admin-btn-hover' }} items-center">
